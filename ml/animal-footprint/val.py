...
# Load val dataset
train_dir = r"animal-footprint-detection\dataset\OpenAnimalTracks\cropped_imgs\val"
...
# Accuracy and classification report for val data
accuracy_train = accuracy_score(y_true_train, y_pred_train)
print(f"\n✅ Validation Accuracy: {accuracy_train * 100:.2f}%")
